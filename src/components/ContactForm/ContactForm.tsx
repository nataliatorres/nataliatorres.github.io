...
const ContactForm = () => {
    ...
    return (
        ...
        <button
            ...
            className='px-6 py-3 rounded-lg bg-[#4F5030] text-[#DFD3BD] font-semibold transition-transform duration-200 hover:scale-105 hover:bg-[#CA9248] disabled:opacity-50 disabled:pointer-events-none'
        >
